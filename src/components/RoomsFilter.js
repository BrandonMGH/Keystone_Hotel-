...
// ** Function below is getting all the unique values from the rooms prop being passed from the Context from the RoomsContainer.js ** //  
           ...
           <form className="filter-form">
               {/*select type */}
                <div className='form-group'>
                    <label htmlFor="type">roomm type</label>
